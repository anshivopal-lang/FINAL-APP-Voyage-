...
/**
 * The four built-in accounts are seeded by the schema script, so nothing here
 * creates or authenticates a user any more. This lookup remains because
 * inviting someone to a holiday is done by email.
 */
